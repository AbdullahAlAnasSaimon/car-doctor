...
const BannerItem = ({slide}) => {
  ...
  return (
      <div id={`slide${id}`} className="carousel-item relative w-full rounded-md">
        ...
        <div className="absolute transform -translate-y-1/2 left-[100px] top-1/3">
        ...
        <div className="absolute transform -translate-y-1/2 left-[100px] top-2/4 mt-10 w-2/5">
        ...
        <div className="absolute transform -translate-y-1/2 left-[100px] -mt-12 top-3/4">
